...
window.onload = function() {
    ...
    // Level properties
    var level = {
        x: 80, //this is being used as a left margin of sorts
        y: 48,
        width: canvas.width - 160, //the canvas is the size of the div minus the x margins 2*80
    ...
    function newGame() {
        // Initialize the ball
        ball.x = level.x + (level.width - ball.width) / 2; //middle of screen
    ...
    function update(tframe) {
        ...
        // Update the fps counter, this unnecessary but may prove useful later.
        updateFps(dt);
